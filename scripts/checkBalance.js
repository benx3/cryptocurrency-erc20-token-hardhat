...
async function main() {
  // ========== CẤU HÌNH ==========
  const contractAddress = "0x1234567890AbCdEf1234567890AbCdEf12345678"; // Thay bằng địa chỉ contract của bạn
  const accountToCheck = "0xYourAddressHere"; // Thay bằng địa chỉ cần kiểm tra
